...
Private Declare Sub SETSTD_WASP Lib "WASPCN.dll" (ByVal StdID As Integer)
Rem ******************************************************************************
Rem 供用户调用，以获知使用的标准
Rem STDID=67 --> IFC67
Rem STDID=97 --> IAPWS-IF97
Private Declare Sub GETSTD_WASP Lib "WASPCN.dll" (ByRef StdID As Integer)
Rem ******************************************************************************

Rem 已知压力(MPa)，求对应饱和温度(℃)
Private Declare Sub P2T Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比焓(kJ/kg)
Private Declare Sub P2HL Lib "WASPCN.dll" (ByVal P As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比焓(kJ/kg)
Private Declare Sub P2HG Lib "WASPCN.dll" (ByVal P As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比熵(kJ/(kg.℃))
Private Declare Sub P2SL Lib "WASPCN.dll" (ByVal P As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比熵(kJ/(kg.℃))
Private Declare Sub P2SG Lib "WASPCN.dll" (ByVal P As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比容(m^3/kg)
Private Declare Sub P2VL Lib "WASPCN.dll" (ByVal P As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比容(m^3/kg)
Private Declare Sub P2VG Lib "WASPCN.dll" (ByVal P As Double, ByRef V As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和温度(℃)、饱和水比焓(kJ/kg)、饱和水比熵(kJ/(kg.℃))、饱和水比容(m^3/kg)
Private Declare Sub P2L Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和温度(℃)、饱和汽比焓(kJ/kg)、饱和汽比熵(kJ/(kg.℃))、饱和汽比容(m^3/kg)
Private Declare Sub P2G Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水定压比热(kJ/(kg.℃))
Private Declare Sub P2CPL Lib "WASPCN.dll" (ByVal P As Double, ByRef CP As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和汽定压比热(kJ/(kg.℃))
Private Declare Sub P2CPG Lib "WASPCN.dll" (ByVal P As Double, ByRef CP As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水定容比热(kJ/(kg.℃))
Private Declare Sub P2CVL Lib "WASPCN.dll" (ByVal P As Double, ByRef CV As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和汽定容比热(kJ/(kg.℃))
Private Declare Sub P2CVG Lib "WASPCN.dll" (ByVal P As Double, ByRef CV As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水内能(kJ/kg)
Private Declare Sub P2EL Lib "WASPCN.dll" (ByVal P As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽内能(kJ/kg)
Private Declare Sub P2EG Lib "WASPCN.dll" (ByVal P As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水音速(m/s)
Private Declare Sub P2SSPL Lib "WASPCN.dll" (ByVal P As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽音速(m/s)
Private Declare Sub P2SSPG Lib "WASPCN.dll" (ByVal P As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水定熵指数
Private Declare Sub P2KSL Lib "WASPCN.dll" (ByVal P As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽定熵指数
Private Declare Sub P2KSG Lib "WASPCN.dll" (ByVal P As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水动力粘度(Pa.s)
Private Declare Sub P2ETAL Lib "WASPCN.dll" (ByVal P As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽动力粘度(Pa.s)
Private Declare Sub P2ETAG Lib "WASPCN.dll" (ByVal P As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水运动粘度(m^2/s)
Private Declare Sub P2UL Lib "WASPCN.dll" (ByVal P As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽运动粘度(m^2/s)
Private Declare Sub P2UG Lib "WASPCN.dll" (ByVal P As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水导热系数(W/(m.℃))
Private Declare Sub P2RAMDL Lib "WASPCN.dll" (ByVal P As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽导热系数(W/(m.℃))
Private Declare Sub P2RAMDG Lib "WASPCN.dll" (ByVal P As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水普朗特数
Private Declare Sub P2PRNL Lib "WASPCN.dll" (ByVal P As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽普朗特数
Private Declare Sub P2PRNG Lib "WASPCN.dll" (ByVal P As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水介电常数
Private Declare Sub P2EPSL Lib "WASPCN.dll" (ByVal P As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽介电常数
Private Declare Sub P2EPSG Lib "WASPCN.dll" (ByVal P As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水折射率
Private Declare Sub P2NL Lib "WASPCN.dll" (ByVal P As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽折射率
Private Declare Sub P2NG Lib "WASPCN.dll" (ByVal P As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)


Rem 已知压力(MPa)和温度(℃)，求比焓(kJ/kg)
Private Declare Sub PT2H Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比熵(kJ/(kg.℃))
Private Declare Sub PT2S Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比容(m^3/kg)
Private Declare Sub PT2V Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求干度(100%)
Private Declare Sub PT2X Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub PT Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定压比热(kJ/(kg.℃))
Private Declare Sub PT2CP Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定容比热(kJ/(kg.℃))
Private Declare Sub PT2CV Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求内能(kJ/kg)
Private Declare Sub PT2E Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求音速(m/s)
Private Declare Sub PT2SSP Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef a As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定熵指数
Private Declare Sub PT2KS Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef K As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求动力粘度(Pa.s)
Private Declare Sub PT2ETA Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求运动粘度(m^2/s)
Private Declare Sub PT2U Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求热传导系数(W/(m.℃))
Private Declare Sub PT2RAMD Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求普朗特数
Private Declare Sub PT2PRN Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求介电常数
Private Declare Sub PT2EPS Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求折射率
Private Declare Sub PT2N Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和比焓(kJ/kg)，求温度(℃)
Private Declare Sub PH2T Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub PH2S Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求比容(m^3/kg)
Private Declare Sub PH2V Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub PH2X Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)
Private Declare Sub PH Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求温度(℃)
Private Declare Sub PS2T Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)
Private Declare Sub PS2H Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求比容(m^3/kg)
Private Declare Sub PS2V Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub PS2X Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求温度(℃)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)
Private Declare Sub Ps Lib "WASPCN.dll" Alias "PS" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)


Rem 已知压力(MPa)和比容(m^3/kg)，求温度(℃)
Private Declare Sub PV2T Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub PV2H Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求比容(m^3/kg)
Private Declare Sub PV2S Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求干度(100%)
Private Declare Sub PV2X Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求温度(℃)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)
Private Declare Sub PV Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和干度(100%)，求温度(℃)
Private Declare Sub PX2T Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比焓(kJ/kg)
Private Declare Sub PX2H Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比熵(kJ/(kg.℃))
Private Declare Sub PX2S Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比容(m^3/kg)
Private Declare Sub PX2V Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub PX Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)

Rem 已知温度(℃)，求饱和压力(MPa)？
Private Declare Sub T2P Lib "WASPCN.dll" (ByVal T As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比焓(kJ/kg)
Private Declare Sub T2HL Lib "WASPCN.dll" (ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比焓(kJ/kg)
Private Declare Sub T2HG Lib "WASPCN.dll" (ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比熵(kJ/(kg.℃))
Private Declare Sub T2SL Lib "WASPCN.dll" (ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比熵(kJ/(kg.℃))
Private Declare Sub T2SG Lib "WASPCN.dll" (ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比容(m^3/kg)
Private Declare Sub T2VL Lib "WASPCN.dll" (ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比容(m^3/kg)
Private Declare Sub T2VG Lib "WASPCN.dll" (ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比焓(kJ/kg)、饱和水比熵(kJ/(kg.℃))、饱和水比容(m^3/kg)
Private Declare Sub T2L Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比焓(kJ/kg)、饱和汽比熵(kJ/(kg.℃))、饱和汽比容(m^3/kg)
Private Declare Sub T2G Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定压比热(kJ/(kg.℃))
Private Declare Sub T2CPL Lib "WASPCN.dll" (ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定压比热(kJ/(kg.℃))
Private Declare Sub T2CPG Lib "WASPCN.dll" (ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定容比热(kJ/(kg.℃))
Private Declare Sub T2CVL Lib "WASPCN.dll" (ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定容比热(kJ/(kg.℃))
Private Declare Sub T2CVG Lib "WASPCN.dll" (ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水内能(kJ/kg)
Private Declare Sub T2EL Lib "WASPCN.dll" (ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽内能(kJ/kg)
Private Declare Sub T2EG Lib "WASPCN.dll" (ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水音速(m/s)
Private Declare Sub T2SSPL Lib "WASPCN.dll" (ByVal T As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽音速(m/s)
Private Declare Sub T2SSPG Lib "WASPCN.dll" (ByVal T As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定熵指数
Private Declare Sub T2KSL Lib "WASPCN.dll" (ByVal T As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定熵指数
Private Declare Sub T2KSG Lib "WASPCN.dll" (ByVal T As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水动力粘度(Pa.s)
Private Declare Sub T2ETAL Lib "WASPCN.dll" (ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽动力粘度(Pa.s)
Private Declare Sub T2ETAG Lib "WASPCN.dll" (ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水运动粘度(m^2/s)
Private Declare Sub T2UL Lib "WASPCN.dll" (ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽运动粘度(m^2/s)
Private Declare Sub T2UG Lib "WASPCN.dll" (ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水导热系数(W/(m.℃))
Private Declare Sub T2RAMDL Lib "WASPCN.dll" (ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽导热系数(W/(m.℃))
Private Declare Sub T2RAMDG Lib "WASPCN.dll" (ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水普朗特数
Private Declare Sub T2PRNL Lib "WASPCN.dll" (ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽普朗特数
Private Declare Sub T2PRNG Lib "WASPCN.dll" (ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水导电率
Private Declare Sub T2EPSL Lib "WASPCN.dll" (ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽介电常数
Private Declare Sub T2EPSG Lib "WASPCN.dll" (ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水折射率
Private Declare Sub T2NL Lib "WASPCN.dll" (ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽折射率
Private Declare Sub T2NG Lib "WASPCN.dll" (ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水表面张力(N/m)
Private Declare Sub T2SURFT Lib "WASPCN.dll" (ByVal T As Double, ByRef SurfT As Double, ByRef Range As Integer)


Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(低压的一个值)
Private Declare Sub TH2PLP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(高压的一个值)
Private Declare Sub TH2PHP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(缺省为低压的一个值)
Private Declare Sub TH2P Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub TH2SLP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub TH2SHP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(缺省为低压的一个值)
Private Declare Sub TH2S Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub TH2VLP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub TH2VHP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(缺省为低压的一个值)
Private Declare Sub TH2V Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2XLP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2XHP Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2X Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(低压的一个值)
Private Declare Sub THLP Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(高压的一个值)
Private Declare Sub THHP Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(缺省为低压的一个值)
Private Declare Sub TH Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(低压的一个值)
Private Declare Sub TS2PLP Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(高压的一个值)
Private Declare Sub TS2PHP Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(缺省为低压的一个值)
Private Declare Sub TS2P Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub TS2HLP Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub TS2HHP Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(缺省为低压的一个值)
Private Declare Sub TS2H Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(低压的一个值)
Private Declare Sub TS2VLP Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(高压的一个值)
Private Declare Sub TS2VHP Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(缺省为低压的一个值)
Private Declare Sub TS2V Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub TS2X Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(低压的一个值)
Private Declare Sub TSLP Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(高压的一个值)
Private Declare Sub TSHP Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(缺省为低压的一个值)
Private Declare Sub Ts Lib "WASPCN.dll" Alias "TS" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)


Rem 已知温度(℃)和比容(m^3/kg)，求压力(MPa)
Private Declare Sub TV2P Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub TV2H Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub TV2S Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求干度(100%)
Private Declare Sub TV2X Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求压力(MPa)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、干度(100%)
Private Declare Sub TV Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知温度(℃)和干度(100%)，求压力(MPa)
Private Declare Sub TX2P Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比焓(kJ/kg)
Private Declare Sub TX2H Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比熵(kJ/(kg.℃))
Private Declare Sub TX2S Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比容(m^3/kg)
Private Declare Sub TX2V Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求压力(MPa)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub TX Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求压力(MPa)
Private Declare Sub HS2P Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求温度(℃)
Private Declare Sub HS2T Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求比容(m^3/kg)
Private Declare Sub HS2V Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub HS2X Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求压力(MPa)、温度(℃)、比容(m^3/kg)、干度(100%)
Private Declare Sub HS Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求压力(MPa)
Private Declare Sub HV2P Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求温度(℃)
Private Declare Sub HV2T Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub HV2S Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求干度(100%)
Private Declare Sub HV2X Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、干度(100%)
Private Declare Sub HV Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub HX2PLP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(高压的一个值)
Private Declare Sub HX2PHP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub HX2P Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub HX2TLP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub HX2THP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub HX2T Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub HX2SLP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub HX2SHP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub HX2S Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub HX2VLP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub HX2VHP Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub HX2V Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(低压的一个值)
Private Declare Sub HXLP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(高压的一个值)
Private Declare Sub HXHP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
...
Private Declare Sub HX Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)


Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求压力(MPa)
Private Declare Sub SV2P Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求温度(℃)
Private Declare Sub SV2T Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub SV2H Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求干度(100%)
Private Declare Sub SV2X Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、干度(100%)
Private Declare Sub SV Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub SX2PLP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(中压的一个值)
Private Declare Sub SX2PMP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(高压的一个值)
Private Declare Sub SX2PHP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub SX2P Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub SX2TLP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(中压的一个值)
Private Declare Sub SX2TMP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub SX2THP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub SX2T Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub SX2HLP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(中压的一个值)
Private Declare Sub SX2HMP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub SX2HHP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(缺省是低压的一个值)
Private Declare Sub SX2H Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub SX2VLP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(中压的一个值)
Private Declare Sub SX2VMP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub SX2VHP Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub SX2V Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(低压的一个值)
Private Declare Sub SXLP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(中压的一个值)
Private Declare Sub SXMP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(高压的一个值)
Private Declare Sub SXHP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub SX Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)


Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub VX2PLP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(低高压的一个值)
Private Declare Sub VX2PHP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub VX2P Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub VX2TLP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub VX2THP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub VX2T Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub VX2HLP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub VX2HHP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(缺省是低压的一个值)
Private Declare Sub VX2H Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub VX2SLP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub VX2SHP Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub VX2S Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub VXLP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub VXHP Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub VX Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)


Rem ******************************************************************************
Rem 已知两个点的X、Y值，线性插值(输入顺序为先两个X,再两个Y)
Rem Private Declare Sub INST2DXX Lib "WASPCN.dll" (ByVal X1 As Double, ByVal X2 As Double, ByVal Y1 As Double, ByVal Y2 As Double, ByVal x As Double, ByRef y As Double)
Rem 已知两个点的X、Y值，线性插值(输入顺序为先一对X,Y ，再一对X,Y)
Rem Private Declare Sub INST2DXY Lib "WASPCN.dll" (ByVal X1 As Double, ByVal Y1 As Double, ByVal X2 As Double, ByVal Y2 As Double, ByVal x As Double, ByRef y As Double)


Private Declare Sub ABOUT_WASP Lib "WASPCN.dll" ()
Private Declare Sub HELP_WASP Lib "WASPCN.dll" ()
Private Declare Sub COPYRIGHT_WASP Lib "WASPCN.dll" ()


Rem ****************************************************************************************************
Rem 已知压力(MPa)，求对应饱和温度(℃)
Private Declare Sub P2T67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比焓(kJ/kg)
Private Declare Sub P2HL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比焓(kJ/kg)
Private Declare Sub P2HG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比熵(kJ/(kg.℃))
Private Declare Sub P2SL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比熵(kJ/(kg.℃))
Private Declare Sub P2SG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比容(m^3/kg)
Private Declare Sub P2VL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比容(m^3/kg)
Private Declare Sub P2VG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef V As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和温度(℃)、饱和水比焓(kJ/kg)、饱和水比熵(kJ/(kg.℃))、饱和水比容(m^3/kg)
Private Declare Sub P2L67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和温度(℃)、饱和汽比焓(kJ/kg)、饱和汽比熵(kJ/(kg.℃))、饱和汽比容(m^3/kg)
Private Declare Sub P2G67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水定压比热(kJ/(kg.℃))
Private Declare Sub P2CPL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef CP As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和汽定压比热(kJ/(kg.℃))
Private Declare Sub P2CPG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef CP As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水定容比热(kJ/(kg.℃))
Private Declare Sub P2CVL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef CV As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和汽定容比热(kJ/(kg.℃))
Private Declare Sub P2CVG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef CV As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水内能(kJ/kg)
Private Declare Sub P2EL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽内能(kJ/kg)
Private Declare Sub P2EG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水音速(m/s)
Private Declare Sub P2SSPL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽音速(m/s)
Private Declare Sub P2SSPG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水定熵指数
Private Declare Sub P2KSL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽定熵指数
Private Declare Sub P2KSG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水动力粘度(Pa.s)
Private Declare Sub P2ETAL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽动力粘度(Pa.s)
Private Declare Sub P2ETAG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水运动粘度(m^2/s)
Private Declare Sub P2UL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽运动粘度(m^2/s)
Private Declare Sub P2UG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水导热系数(W/(m.℃))
Private Declare Sub P2RAMDL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽导热系数(W/(m.℃))
Private Declare Sub P2RAMDG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水普朗特数
Private Declare Sub P2PRNL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽普朗特数
Private Declare Sub P2PRNG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水介电常数
Private Declare Sub P2EPSL67 Lib "WASPCN.dll" (ByVal P As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽介电常数
Private Declare Sub P2EPSG67 Lib "WASPCN.dll" (ByVal P As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水折射率
Private Declare Sub P2NL67 Lib "WASPCN.dll" (ByVal P As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽折射率
Private Declare Sub P2NG67 Lib "WASPCN.dll" (ByVal P As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)


Rem 已知压力(MPa)和温度(℃)，求比焓(kJ/kg)
Private Declare Sub PT2H67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比熵(kJ/(kg.℃))
Private Declare Sub PT2S67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比容(m^3/kg)
Private Declare Sub PT2V67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求干度(100%)
Private Declare Sub PT2X67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub PT67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定压比热(kJ/(kg.℃))
Private Declare Sub PT2CP67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定容比热(kJ/(kg.℃))
Private Declare Sub PT2CV67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求内能(kJ/kg)
Private Declare Sub PT2E67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求音速(m/s)
Private Declare Sub PT2SSP67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef a As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定熵指数
Private Declare Sub PT2KS67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef K As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求动力粘度(Pa.s)
Private Declare Sub PT2ETA67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求运动粘度(m^2/s)
Private Declare Sub PT2U67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求热传导系数(W/(m.℃))
Private Declare Sub PT2RAMD67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求普朗特数
Private Declare Sub PT2PRN67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求介电常数
Private Declare Sub PT2EPS67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求折射率
Private Declare Sub PT2N67 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和比焓(kJ/kg)，求温度(℃)
Private Declare Sub PH2T67 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub PH2S67 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求比容(m^3/kg)
Private Declare Sub PH2V67 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub PH2X67 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)
Private Declare Sub PH67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求温度(℃)
Private Declare Sub PS2T67 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)
Private Declare Sub PS2H67 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求比容(m^3/kg)
Private Declare Sub PS2V67 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub PS2X67 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求温度(℃)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)
Private Declare Sub PS67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)


Rem 已知压力(MPa)和比容(m^3/kg)，求温度(℃)
Private Declare Sub PV2T67 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub PV2H67 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求比容(m^3/kg)
Private Declare Sub PV2S67 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求干度(100%)
Private Declare Sub PV2X67 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求温度(℃)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)
Private Declare Sub PV67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和干度(100%)，求温度(℃)
Private Declare Sub PX2T67 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比焓(kJ/kg)
Private Declare Sub PX2H67 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比熵(kJ/(kg.℃))
Private Declare Sub PX2S67 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比容(m^3/kg)
Private Declare Sub PX2V67 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub PX67 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)

Rem 已知温度(℃)，求饱和压力(MPa)？
Private Declare Sub T2P67 Lib "WASPCN.dll" (ByVal T As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比焓(kJ/kg)
Private Declare Sub T2HL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比焓(kJ/kg)
Private Declare Sub T2HG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比熵(kJ/(kg.℃))
Private Declare Sub T2SL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比熵(kJ/(kg.℃))
Private Declare Sub T2SG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比容(m^3/kg)
Private Declare Sub T2VL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比容(m^3/kg)
Private Declare Sub T2VG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比焓(kJ/kg)、饱和水比熵(kJ/(kg.℃))、饱和水比容(m^3/kg)
Private Declare Sub T2L67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比焓(kJ/kg)、饱和汽比熵(kJ/(kg.℃))、饱和汽比容(m^3/kg)
Private Declare Sub T2G67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定压比热(kJ/(kg.℃))
Private Declare Sub T2CPL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定压比热(kJ/(kg.℃))
Private Declare Sub T2CPG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定容比热(kJ/(kg.℃))
Private Declare Sub T2CVL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定容比热(kJ/(kg.℃))
Private Declare Sub T2CVG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水内能(kJ/kg)
Private Declare Sub T2EL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽内能(kJ/kg)
Private Declare Sub T2EG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水音速(m/s)
Private Declare Sub T2SSPL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽音速(m/s)
Private Declare Sub T2SSPG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定熵指数
Private Declare Sub T2KSL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定熵指数
Private Declare Sub T2KSG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水动力粘度(Pa.s)
Private Declare Sub T2ETAL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽动力粘度(Pa.s)
Private Declare Sub T2ETAG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水运动粘度(m^2/s)
Private Declare Sub T2UL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽运动粘度(m^2/s)
Private Declare Sub T2UG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水导热系数(W/(m.℃))
Private Declare Sub T2RAMDL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽导热系数(W/(m.℃))
Private Declare Sub T2RAMDG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水普朗特数
Private Declare Sub T2PRNL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽普朗特数
Private Declare Sub T2PRNG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水导电率
Private Declare Sub T2EPSL67 Lib "WASPCN.dll" (ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽介电常数
Private Declare Sub T2EPSG67 Lib "WASPCN.dll" (ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水折射率
Private Declare Sub T2NL67 Lib "WASPCN.dll" (ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽折射率
Private Declare Sub T2NG67 Lib "WASPCN.dll" (ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水表面张力(N/m)
Private Declare Sub T2SURFT67 Lib "WASPCN.dll" (ByVal T As Double, ByRef SurfT As Double, ByRef Range As Integer)


Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(低压的一个值)
Private Declare Sub TH2PLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(高压的一个值)
Private Declare Sub TH2PHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(缺省为低压的一个值)
Private Declare Sub TH2P67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub TH2SLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub TH2SHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(缺省为低压的一个值)
Private Declare Sub TH2S67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub TH2VLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub TH2VHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(缺省为低压的一个值)
Private Declare Sub TH2V67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2XLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2XHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2X67 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(低压的一个值)
Private Declare Sub THLP67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(高压的一个值)
Private Declare Sub THHP67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(缺省为低压的一个值)
Private Declare Sub TH67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(低压的一个值)
Private Declare Sub TS2PLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(高压的一个值)
Private Declare Sub TS2PHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(缺省为低压的一个值)
Private Declare Sub TS2P67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub TS2HLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub TS2HHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(缺省为低压的一个值)
Private Declare Sub TS2H67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(低压的一个值)
Private Declare Sub TS2VLP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(高压的一个值)
Private Declare Sub TS2VHP67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(缺省为低压的一个值)
Private Declare Sub TS2V67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub TS2X67 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(低压的一个值)
Private Declare Sub TSLP67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(高压的一个值)
Private Declare Sub TSHP67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(缺省为低压的一个值)
Private Declare Sub TS67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)


Rem 已知温度(℃)和比容(m^3/kg)，求压力(MPa)
Private Declare Sub TV2P67 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub TV2H67 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub TV2S67 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求干度(100%)
Private Declare Sub TV2X67 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求压力(MPa)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、干度(100%)
Private Declare Sub TV67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知温度(℃)和干度(100%)，求压力(MPa)
Private Declare Sub TX2P67 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比焓(kJ/kg)
Private Declare Sub TX2H67 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比熵(kJ/(kg.℃))
Private Declare Sub TX2S67 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比容(m^3/kg)
Private Declare Sub TX2V67 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求压力(MPa)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub TX67 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求压力(MPa)
Private Declare Sub HS2P67 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求温度(℃)
Private Declare Sub HS2T67 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求比容(m^3/kg)
Private Declare Sub HS2V67 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub HS2X67 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求压力(MPa)、温度(℃)、比容(m^3/kg)、干度(100%)
Private Declare Sub HS67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求压力(MPa)
Private Declare Sub HV2P67 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求温度(℃)
Private Declare Sub HV2T67 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub HV2S67 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求干度(100%)
Private Declare Sub HV2X67 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、干度(100%)
Private Declare Sub HV67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub HX2PLP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(高压的一个值)
Private Declare Sub HX2PHP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub HX2P67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub HX2TLP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub HX2THP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub HX2T67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub HX2SLP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub HX2SHP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub HX2S67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub HX2VLP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub HX2VHP67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub HX2V67 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(低压的一个值)
Private Declare Sub HXLP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(高压的一个值)
Private Declare Sub HXHP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(缺省是低压的一个值)
Rem Procedure HX67(Var P,T:Double;Const H:Double;Var S,V:Double;Const X:Double;Var Range:Integer);StdCall;
Private Declare Sub HX67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)


Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求压力(MPa)
Private Declare Sub SV2P67 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求温度(℃)
Private Declare Sub SV2T67 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub SV2H67 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求干度(100%)
Private Declare Sub SV2X67 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、干度(100%)
Private Declare Sub SV67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub SX2PLP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(中压的一个值)
Private Declare Sub SX2PMP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(高压的一个值)
Private Declare Sub SX2PHP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub SX2P67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub SX2TLP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(中压的一个值)
Private Declare Sub SX2TMP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub SX2THP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub SX2T67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub SX2HLP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(中压的一个值)
Private Declare Sub SX2HMP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub SX2HHP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(缺省是低压的一个值)
Private Declare Sub SX2H67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub SX2VLP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(中压的一个值)
Private Declare Sub SX2VMP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub SX2VHP67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub SX2V67 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(低压的一个值)
Private Declare Sub SXLP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(中压的一个值)
Private Declare Sub SXMP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(高压的一个值)
Private Declare Sub SXHP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub SX67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)


Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub VX2PLP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(低高压的一个值)
Private Declare Sub VX2PHP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub VX2P67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub VX2TLP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub VX2THP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub VX2T67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub VX2HLP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub VX2HHP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(缺省是低压的一个值)
Private Declare Sub VX2H67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub VX2SLP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub VX2SHP67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub VX2S67 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub VXLP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub VXHP67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub VX67 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)


Rem ****************************************************************************************************

Rem 已知压力(MPa)，求对应饱和温度(℃)
Private Declare Sub P2T97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比焓(kJ/kg)
Private Declare Sub P2HL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比焓(kJ/kg)
Private Declare Sub P2HG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比熵(kJ/(kg.℃))
Private Declare Sub P2SL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比熵(kJ/(kg.℃))
Private Declare Sub P2SG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水比容(m^3/kg)
Private Declare Sub P2VL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽比容(m^3/kg)
Private Declare Sub P2VG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef V As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和温度(℃)、饱和水比焓(kJ/kg)、饱和水比熵(kJ/(kg.℃))、饱和水比容(m^3/kg)
Private Declare Sub P2L97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和温度(℃)、饱和汽比焓(kJ/kg)、饱和汽比熵(kJ/(kg.℃))、饱和汽比容(m^3/kg)
Private Declare Sub P2G97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水定压比热(kJ/(kg.℃))
Private Declare Sub P2CPL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef CP As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和汽定压比热(kJ/(kg.℃))
Private Declare Sub P2CPG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef CP As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水定容比热(kJ/(kg.℃))
Private Declare Sub P2CVL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef CV As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和汽定容比热(kJ/(kg.℃))
Private Declare Sub P2CVG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef CV As Double, ByRef Range As Integer)
Rem  已知压力(MPa)，求对应饱和水内能(kJ/kg)
Private Declare Sub P2EL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽内能(kJ/kg)
Private Declare Sub P2EG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水音速(m/s)
Private Declare Sub P2SSPL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽音速(m/s)
Private Declare Sub P2SSPG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水定熵指数
Private Declare Sub P2KSL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽定熵指数
Private Declare Sub P2KSG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水动力粘度(Pa.s)
Private Declare Sub P2ETAL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽动力粘度(Pa.s)
Private Declare Sub P2ETAG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水运动粘度(m^2/s)
Private Declare Sub P2UL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽运动粘度(m^2/s)
Private Declare Sub P2UG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水导热系数(W/(m.℃))
Private Declare Sub P2RAMDL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽导热系数(W/(m.℃))
Private Declare Sub P2RAMDG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水普朗特数
Private Declare Sub P2PRNL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽普朗特数
Private Declare Sub P2PRNG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水导电系数
Private Declare Sub P2EPSL97 Lib "WASPCN.dll" (ByVal P As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽导电系数
Private Declare Sub P2EPSG97 Lib "WASPCN.dll" (ByVal P As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和水折射率
Private Declare Sub P2NL97 Lib "WASPCN.dll" (ByVal P As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知压力(MPa)，求对应饱和汽折射率
Private Declare Sub P2NG97 Lib "WASPCN.dll" (ByVal P As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)


Rem 已知压力(MPa)和温度(℃)，求比焓(kJ/kg)
Private Declare Sub PT2H97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比熵(kJ/(kg.℃))
Private Declare Sub PT2S97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比容(m^3/kg)
Private Declare Sub PT2V97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求干度(100%)
Private Declare Sub PT2X97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub PT97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定压比热(kJ/(kg.℃))
Private Declare Sub PT2CP97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定容比热(kJ/(kg.℃))
Private Declare Sub PT2CV97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求内能(kJ/kg)
Private Declare Sub PT2E97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求音速(m/s)
Private Declare Sub PT2SSP97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef a As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求定熵指数
Private Declare Sub PT2KS97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef K As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求动力粘度(Pa.s)
Private Declare Sub PT2ETA97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求运动粘度(m^2/s)
Private Declare Sub PT2U97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求热传导系数(W/(m.℃))
Private Declare Sub PT2RAMD97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求普朗特数
Private Declare Sub PT2PRN97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求介电常数
Private Declare Sub PT2EPS97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和温度(℃)，求折射率
Private Declare Sub PT2N97 Lib "WASPCN.dll" (ByVal P As Double, ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和比焓(kJ/kg)，求温度(℃)
Private Declare Sub PH2T97 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub PH2S97 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求比容(m^3/kg)
Private Declare Sub PH2V97 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub PH2X97 Lib "WASPCN.dll" (ByVal P As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比焓(kJ/kg)，求温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)
Private Declare Sub PH97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求温度(℃)
Private Declare Sub PS2T97 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)
Private Declare Sub PS2H97 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求比容(m^3/kg)
Private Declare Sub PS2V97 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub PS2X97 Lib "WASPCN.dll" (ByVal P As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比熵(kJ/(kg.℃))，求温度(℃)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)
Private Declare Sub PS97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)


Rem 已知压力(MPa)和比容(m^3/kg)，求温度(℃)
Private Declare Sub PV2T97 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub PV2H97 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求比容(m^3/kg)
Private Declare Sub PV2S97 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求干度(100%)
Private Declare Sub PV2X97 Lib "WASPCN.dll" (ByVal P As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和比容(m^3/kg)，求温度(℃)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)
Private Declare Sub PV97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知压力(MPa)和干度(100%)，求温度(℃)
Private Declare Sub PX2T97 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比焓(kJ/kg)
Private Declare Sub PX2H97 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比熵(kJ/(kg.℃))
Private Declare Sub PX2S97 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求比容(m^3/kg)
Private Declare Sub PX2V97 Lib "WASPCN.dll" (ByVal P As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知压力(MPa)和干度(100%)，求温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub PX97 Lib "WASPCN.dll" (ByVal P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)

Rem 已知温度(℃)，求饱和压力(MPa)？
Private Declare Sub T2P97 Lib "WASPCN.dll" (ByVal T As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比焓(kJ/kg)
Private Declare Sub T2HL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比焓(kJ/kg)
Private Declare Sub T2HG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比熵(kJ/(kg.℃))
Private Declare Sub T2SL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比熵(kJ/(kg.℃))
Private Declare Sub T2SG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比容(m^3/kg)
Private Declare Sub T2VL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比容(m^3/kg)
Private Declare Sub T2VG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水比焓(kJ/kg)、饱和水比熵(kJ/(kg.℃))、饱和水比容(m^3/kg)
Private Declare Sub T2L97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽比焓(kJ/kg)、饱和汽比熵(kJ/(kg.℃))、饱和汽比容(m^3/kg)
Private Declare Sub T2G97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定压比热(kJ/(kg.℃))
Private Declare Sub T2CPL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定压比热(kJ/(kg.℃))
Private Declare Sub T2CPG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef CP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定容比热(kJ/(kg.℃))
Private Declare Sub T2CVL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定容比热(kJ/(kg.℃))
Private Declare Sub T2CVG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef CV As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水内能(kJ/kg)
Private Declare Sub T2EL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽内能(kJ/kg)
Private Declare Sub T2EG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef E As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水音速(m/s)
Private Declare Sub T2SSPL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽音速(m/s)
Private Declare Sub T2SSPG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef SSP As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水定熵指数
Private Declare Sub T2KSL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽定熵指数
Private Declare Sub T2KSG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef KS As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水动力粘度(Pa.s)
Private Declare Sub T2ETAL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽动力粘度(Pa.s)
Private Declare Sub T2ETAG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef ETA As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水运动粘度(m^2/s)
Private Declare Sub T2UL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽运动粘度(m^2/s)
Private Declare Sub T2UG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef U As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水导热系数(W/(m.℃))
Private Declare Sub T2RAMDL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽导热系数(W/(m.℃))
Private Declare Sub T2RAMDG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef RAMD As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水普朗特数
Private Declare Sub T2PRNL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽普朗特数
Private Declare Sub T2PRNG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef PRN As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水介电常数
Private Declare Sub T2EPSL97 Lib "WASPCN.dll" (ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽介电常数
Private Declare Sub T2EPSG97 Lib "WASPCN.dll" (ByVal T As Double, ByRef eps As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水折射率
Private Declare Sub T2NL97 Lib "WASPCN.dll" (ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和汽折射率
Private Declare Sub T2NG97 Lib "WASPCN.dll" (ByVal T As Double, ByVal Lamd As Double, ByRef n As Double, ByRef Range As Integer)
Rem 已知温度(℃)，求饱和水表面张力(N/m)
Private Declare Sub T2SURFT97 Lib "WASPCN.dll" (ByVal T As Double, ByRef SurfT As Double, ByRef Range As Integer)


Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(低压的一个值)
Private Declare Sub TH2PLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(高压的一个值)
Private Declare Sub TH2PHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)(缺省为低压的一个值)
Private Declare Sub TH2P97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub TH2SLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub TH2SHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比熵(kJ/(kg.℃))(缺省为低压的一个值)
Private Declare Sub TH2S97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub TH2VLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub TH2VHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求比容(m^3/kg)(缺省为低压的一个值)
Private Declare Sub TH2V97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2XLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2XHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求干度(100%)
Private Declare Sub TH2X97 Lib "WASPCN.dll" (ByVal T As Double, ByVal H As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(低压的一个值)
Private Declare Sub THLP97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(高压的一个值)
Private Declare Sub THHP97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比焓(kJ/kg)，求压力(MPa)、比熵(kJ/(kg.℃))、比容(m^3/kg)、干度(100%)(缺省为低压的一个值)
Private Declare Sub TH97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(低压的一个值)
Private Declare Sub TS2PLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(高压的一个值)
Private Declare Sub TS2PHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)(缺省为低压的一个值)
Private Declare Sub TS2P97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub TS2HLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub TS2HHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比焓(kJ/kg)(缺省为低压的一个值)
Private Declare Sub TS2H97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(低压的一个值)
Private Declare Sub TS2VLP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(高压的一个值)
Private Declare Sub TS2VHP97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求比容(m^3/kg)(缺省为低压的一个值)
Private Declare Sub TS2V97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub TS2X97 Lib "WASPCN.dll" (ByVal T As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(低压的一个值)
Private Declare Sub TSLP97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(高压的一个值)
Private Declare Sub TSHP97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比熵(kJ/(kg.℃))，求压力(MPa)、比焓(kJ/kg)、比容(m^3/kg)、干度(100%)(缺省为低压的一个值)
Private Declare Sub TS97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)


Rem 已知温度(℃)和比容(m^3/kg)，求压力(MPa)
Private Declare Sub TV2P97 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub TV2H97 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub TV2S97 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求干度(100%)
Private Declare Sub TV2X97 Lib "WASPCN.dll" (ByVal T As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知温度(℃)和比容(m^3/kg)，求压力(MPa)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、干度(100%)
Private Declare Sub TV97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知温度(℃)和干度(100%)，求压力(MPa)
Private Declare Sub TX2P97 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比焓(kJ/kg)
Private Declare Sub TX2H97 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比熵(kJ/(kg.℃))
Private Declare Sub TX2S97 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求比容(m^3/kg)
Private Declare Sub TX2V97 Lib "WASPCN.dll" (ByVal T As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知温度(℃)和干度(100%)，求压力(MPa)、比焓(kJ/kg)、比熵(kJ/(kg.℃))、比容(m^3/kg)
Private Declare Sub TX97 Lib "WASPCN.dll" (ByRef P As Double, ByVal T As Double, ByRef H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求压力(MPa)
Private Declare Sub HS2P97 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求温度(℃)
Private Declare Sub HS2T97 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求比容(m^3/kg)
Private Declare Sub HS2V97 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求干度(100%)
Private Declare Sub HS2X97 Lib "WASPCN.dll" (ByVal H As Double, ByVal S As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比熵(kJ/(kg.℃))，求压力(MPa)、温度(℃)、比容(m^3/kg)、干度(100%)
Private Declare Sub HS97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByVal S As Double, ByRef V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求压力(MPa)
Private Declare Sub HV2P97 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求温度(℃)
Private Declare Sub HV2T97 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求比熵(kJ/(kg.℃))
Private Declare Sub HV2S97 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求干度(100%)
Private Declare Sub HV2X97 Lib "WASPCN.dll" (ByVal H As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和比容(m^3/kg)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、干度(100%)
Private Declare Sub HV97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub HX2PLP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(高压的一个值)
Private Declare Sub HX2PHP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub HX2P97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub HX2TLP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub HX2THP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub HX2T97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub HX2SLP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub HX2SHP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub HX2S97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub HX2VLP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub HX2VHP97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub HX2V97 Lib "WASPCN.dll" (ByVal H As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(低压的一个值)
Private Declare Sub HXLP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(高压的一个值)
Private Declare Sub HXHP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比焓(kJ/kg)和干度(100%)，求压力(MPa)、温度(℃)、比熵(kJ/(kg.℃))、比容(m^3/kg)(缺省是低压的一个值)
Rem Procedure HX97(Var P,T:Double;Const H:Double;Var S,V:Double;Const X:Double;Var Range:Integer);StdCall;
Private Declare Sub HX97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByVal H As Double, ByRef S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)


Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求压力(MPa)
Private Declare Sub SV2P97 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求温度(℃)
Private Declare Sub SV2T97 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求比焓(kJ/kg)
Private Declare Sub SV2H97 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求干度(100%)
Private Declare Sub SV2X97 Lib "WASPCN.dll" (ByVal S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和比容(m^3/kg)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、干度(100%)
Private Declare Sub SV97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByVal V As Double, ByRef X As Double, ByRef Range As Integer)

Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub SX2PLP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(中压的一个值)
Private Declare Sub SX2PMP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(高压的一个值)
Private Declare Sub SX2PHP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub SX2P97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub SX2TLP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(中压的一个值)
Private Declare Sub SX2TMP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub SX2THP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub SX2T97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub SX2HLP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(中压的一个值)
Private Declare Sub SX2HMP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub SX2HHP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比焓(kJ/kg)(缺省是低压的一个值)
Private Declare Sub SX2H97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(低压的一个值)
Private Declare Sub SX2VLP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(中压的一个值)
Private Declare Sub SX2VMP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(高压的一个值)
Private Declare Sub SX2VHP97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub SX2V97 Lib "WASPCN.dll" (ByVal S As Double, ByVal X As Double, ByRef V As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(低压的一个值)
Private Declare Sub SXLP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(中压的一个值)
Private Declare Sub SXMP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(高压的一个值)
Private Declare Sub SXHP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比熵(kJ/(kg.℃))和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比容(m^3/kg)(缺省是低压的一个值)
Private Declare Sub SX97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByVal S As Double, ByRef V As Double, ByVal X As Double, ByRef Range As Integer)


Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(低压的一个值)
Private Declare Sub VX2PLP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(低高压的一个值)
Private Declare Sub VX2PHP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)(缺省是低压的一个值)
Private Declare Sub VX2P97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef P As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(低压的一个值)
Private Declare Sub VX2TLP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(高压的一个值)
Private Declare Sub VX2THP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求温度(℃)(缺省是低压的一个值)
Private Declare Sub VX2T97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef T As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(低压的一个值)
Private Declare Sub VX2HLP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(高压的一个值)
Private Declare Sub VX2HHP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比焓(kJ/kg)(缺省是低压的一个值)
Private Declare Sub VX2H97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef H As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub VX2SLP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub VX2SHP97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub VX2S97 Lib "WASPCN.dll" (ByVal V As Double, ByVal X As Double, ByRef S As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(低压的一个值)
Private Declare Sub VXLP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(高压的一个值)
Private Declare Sub VXHP97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
Rem 已知比容(m^3/kg)和干度(100%)，求压力(MPa)、温度(℃)、比焓(kJ/kg)、比熵(kJ/(kg.℃))(缺省是低压的一个值)
Private Declare Sub VX97 Lib "WASPCN.dll" (ByRef P As Double, ByRef T As Double, ByRef H As Double, ByRef S As Double, ByVal V As Double, ByVal X As Double, ByRef Range As Integer)
